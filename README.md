...
このリポジトリは、2026年開催予定のRoboCup JapanOpen @Space Challengeの概要やルールをまとめるためのものになります。
...
## シミュレータ環境
RoboCup JapanOpen 2026 @Space Challengeでは、JAXAが開発したInt-Ball2のGazeboシミュレータを用います。
